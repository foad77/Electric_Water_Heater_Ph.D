...
Group=[t_in,t_amb,price_of_power,tomorrow_volume_withdrawn,tomorrow_t_out,t_out,historical_volume_withdrawn,day_set]
for g in Group:
    g.clear()
#=========================================================================
### Region for tomorrow
...
region_label_tomorrow = 'A{}:N{}'.format(lookback_start_row_tomorrow, lookback_end_row_tomorrow)
...
if current_day>=(lookback_length+1):
   ...
   region_label = 'A{}:J{}'.format(lookback_start_row, lookback_end_row)
...
if current_day==(lookback_length):
   ...
   region_label2 = 'A{}:J{}'.format(start_row2, end_row2)
   ...
   region_label1 = 'A{}:J{}'.format(start_row1, end_row1)
...
### it is used asprediction for the Du&Lu and Apt&goh.
for i in interval_set:
    energy_req_average[i]= sum (energy_req[a,i] for a in day_set)/lookback_length
#=====================================================================
